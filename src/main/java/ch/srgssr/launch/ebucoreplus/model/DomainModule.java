...
public enum DomainModule {
  ...
  PLANNING_PUBLICATION_PLAN(
      "ch.srgssr.launch.planning.publicationplan", "PublicationPlan", "PublicationPlanType"),
  ...
  PUBLICATION(
      "ch.srgssr.launch.publication",
      "PublicationPlatform",
      "PublicationEvent",
      "PublicationChannelType",
      "PublicationEventType"),
  CONSUMPTION(
      "ch.srgssr.launch.consumption",
      "Consumer",
      "ConsumptionEvent",
      "ConsumptionLicence",
      "ConsumptionCount",
  ...
  UNKNOWN("ch.srgssr.launch.unknown");
